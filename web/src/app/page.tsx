    ...
    <>
      ...
      <section className="max-w-2xl mx-auto px-4 py-16 space-y-10">
        <p className="text-sm text-neutral-400 text-center">
          Monitor do SIGAA (Sistema Integrado de Gestao de Atividades Academicas) da UnB.
          Verificamos automaticamente se o sistema esta no ar, lento ou fora do ar a cada 3 minutos
          com 3 camadas: acesso ao servidor, pagina de login e formulario de autenticacao.
        </p>
        ...
        <footer className="text-center pt-8 text-xs text-neutral-400 flex flex-col items-center gap-3">
          ...
          <div className="flex gap-4 items-center">
            <a
              href="https://github.com/m9tzin/sigaa-caiu-unb"
              target="_blank"
            ...
            <span className="inline-flex items-center gap-1.5">
              ...
              >
                ...
                trindadetiago/sigaa-caiu
              </a>
            </span>
          </div>
          <div className="flex flex-col items-center gap-1">
            <p>Esse sigaacaiu e da UNB. Procurando por outros? Acesse abaixo:</p>
            <a
